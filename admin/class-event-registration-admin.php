...
class Event_Registration_Admin {
	...
	public function enqueue_styles() {
		...
		wp_register_style('myPluginStylesheet', plugin_dir_url('css/event-registration-admin.css', __FILE__ ), array(), $this->version, 'all' );
	...
	public function add_plugin_admin_menu() {
		...
		$page = add_submenu_page( 'options-general.php', __( 'Event Registration', 'wpecr' ), __( 'Event Registration', 'wpecr' ), 'manage_options', 'wpecr_options', array( $this, 'wpecr_options_page' ) );
